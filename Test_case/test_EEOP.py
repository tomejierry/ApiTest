...
from ApiTest.Comm.Filepath import reportpath, casepath
...
def test_EEOP(datas):
    ...
    loggings.info(f'用例编号: {case_id},用例标题: {case_name}')
    loggings.info(f'请求地址：{url},请求方式:{method}')
    loggings.info('请求参数：' + dic)
